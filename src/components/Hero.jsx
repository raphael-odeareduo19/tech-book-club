...
const Hero = () => {
    return (
        ...
        <div className={`px-5 bg-[url(${heroBg})] bg-cover bg-no-repeat`}>
            ...
            <section className="hero flex flex-col gap-20 pb-16 md:grid md:items-center md:grid-cols-2">
                <div className="hero-textbox flex flex-col gap-8">
                    ...
                    <a 
                        className="uppercase font-[Martian_Mono] text-lg font-semibold tracking-tighter bg-[#fff5ef] border-3 rounded-md p-4 flex items-center justify-center gap-8 shadow-lg  
                        hover:-translate-y-[2px] hover:shadow-xl transition-all duration-250 active:translate-y-[2px] active:opacity-70 active:shadow-none" 
                        href="#"
                    >
